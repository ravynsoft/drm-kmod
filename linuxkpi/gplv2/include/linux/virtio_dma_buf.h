...
#ifndef __LKPI_LINUX_VIRTIO_DMA_BUF_H
#define __LKPI_LINUX_VIRTIO_DMA_BUF_H
...
struct virtio_dma_buf_ops {
	...
	int (*get_uuid)(struct dma_buf *dma_buf, uint64_t *uuid);
};
...
int virtio_dma_buf_get_uuid(struct dma_buf *dma_buf, uint64_t *uuid);
